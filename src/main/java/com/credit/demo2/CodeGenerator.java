...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/test?autoReconnect=true&useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=false");
        ...
        pcConfig.setParent("com.credit.demo2")
                .setMapper("mapper")
                .setService("service")
...
//        strategy.setTablePrefix(""); //设置表前缀
        strategy.setInclude("realm"); //生成表的名字
